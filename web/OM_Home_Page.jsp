    ...
    <body style="background-image: url(&quot;assets/img/mike-kenneally-TD4DBagg2wE-unsplash1.jpg&quot;);background-color: transparent">
        ...
        <div class="container-fluid vertical-center">    
            <div class="row">
                ...
                <div class="col-sm">
                    <a href="OM_Change_Pass.jsp" class="btn btn-default btn-circle btn-xl shadow-lg" style="margin-left: 55%"><i class="fas fa-users" style="font-size: 180px;"></i><br><h2 class="font-weight-bold">Account</h2></a>
                </div>
                <div class="col-sm">
