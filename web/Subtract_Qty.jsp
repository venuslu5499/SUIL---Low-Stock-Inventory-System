...
<html>
    <head>
        ...
        <script type="text/javascript">
            window.onload = function () {
                ...
                var test = <%=(Boolean) request.getAttribute("subModal")%>;
                if (test === true) {
                    $("#subModal").modal('show');
                } else {
                    $("#subModal").modal('hide');
    ...
    <body style="background-image: url(&quot;assets/img/mike-kenneally-TD4DBagg2wE-unsplash.jpg&quot;);">
        ...
        <div id="wrapper">
            ...
            <form action="subQty" method="POST">
                                        ...
                                        <div class="row  container-fluid">
                                            <div class="col-md-6 text-left align-items-start align-content-start align-self-start mr-auto">
                                                <div class="text-right text-md-right dataTables_filter form-inline mt-3" id="dataTable_filter" style="height: 20px;margin-bottom: 5px;">                               
                                                    <script>
                                                        function getInput(e) {
                                                            e.href = e.href + "?searchSubInput=" + document.getElementById('searchInput').value;
                                                        }
                                                    </script>
                                                    <div class="input-group">
                                                        <input type="text" id="searchInput" name="searchSubInput" value="" class="form-control form-control-sm" aria-controls="dataTable" placeholder="Search Inventory" style="width: 300px;">
                                                        <span class="input-group-btn">                                                  
                                                            <a href = "searchQty" name="searchSubInput" type="submit" class="btn btn-default text-truncate float-right float-sm-none add-another-btn" onclick="getInput(this)"><span class="glyphicon glyphicon-search"></span> Search</a>                                  
                                                        </span>
                                                    </div>
                                                    <label></label>
                                                </div>
                                            ...
                                            <table id="itemTable" class="display table" style="text-align: center" width="100%">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th scope="col" style="text-align: center">Item Name <a href="sortInventory?header=ITEM_DESCRIPTION&page=sub" style="text-decoration: none; color: black"><i class="fas fa-sort"></i></a></th>
                                                        <th scope="col" style="text-align: center">Supplier Name <a href="sortInventory?header=SUPPLIER_NAME&page=sub" style="text-decoration: none; color: black"><i class="fas fa-sort"></i></a></th>
                                                        <th scope="col" style="text-align: center">Current Quantity <a href="sortInventory?header=ITEM_QUANTITY&page=sub" style="text-decoration: none; color: black"><i class="fas fa-sort"></i></a></th>
                                                        <th scope="col" style="text-align: center">Status</th>
                                                        <th scope="col" style="text-align: center">Reduced Quantity</th>
                                                    </tr>
                                                </thead>
                                                <c:forEach items="${inventoryList}" var="items" varStatus="status">
                                                    <tr>
                                                        ...
                                                        <td><center><input class="form-control w-50" style="text-align: center" name="subQty" value="0" placeholder="0" type="number"  min="0"></center></td>
                                                    </tr>  
                                                </c:forEach>     
                                            </table>
                                        </div>
